...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_sign_in_user_id = QLineEdit(self.centralwidget)
        self.lineEdit_sign_in_user_id.setObjectName(u"lineEdit_sign_in_user_id")
        sizePolicy3 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.lineEdit_sign_in_user_id.sizePolicy().hasHeightForWidth())
        self.lineEdit_sign_in_user_id.setSizePolicy(sizePolicy3)

        self.horizontalLayout_2.addWidget(self.lineEdit_sign_in_user_id)
        ...
        self.lineEdit_sign_in_user_pwd = QLineEdit(self.centralwidget)
        self.lineEdit_sign_in_user_pwd.setObjectName(u"lineEdit_sign_in_user_pwd")

        self.horizontalLayout_3.addWidget(self.lineEdit_sign_in_user_pwd)
        ...
        self.label_sign_in_result = QLabel(self.centralwidget)
        self.label_sign_in_result.setObjectName(u"label_sign_in_result")

        self.verticalLayout_3.addWidget(self.label_sign_in_result)
        ...
        self.lineEdit_sign_up_user_id = QLineEdit(self.centralwidget)
        self.lineEdit_sign_up_user_id.setObjectName(u"lineEdit_sign_up_user_id")

        self.horizontalLayout_5.addWidget(self.lineEdit_sign_up_user_id)
        ...
        self.lineEdit_sign_up_user_pwd = QLineEdit(self.centralwidget)
        self.lineEdit_sign_up_user_pwd.setObjectName(u"lineEdit_sign_up_user_pwd")

        self.horizontalLayout_6.addWidget(self.lineEdit_sign_up_user_pwd)
        ...
        self.horizontalLayout_7.addWidget(self.pushButton_sign_up)


        self.verticalLayout_3.addLayout(self.horizontalLayout_7)

        self.label_sign_up_result = QLabel(self.centralwidget)
        self.label_sign_up_result.setObjectName(u"label_sign_up_result")

        self.verticalLayout_3.addWidget(self.label_sign_up_result)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Sign in (\uacc4\uc815 \ub85c\uadf8\uc778)", None))
        ...
        self.pushButton_sign_in.setText(QCoreApplication.translate("MainWindow", u"Sign in", None))
        self.label_sign_in_result.setText("")
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Sign up (\ud68c\uc6d0\uac00\uc785)", None))
        ...
        self.pushButton_sign_up.setText(QCoreApplication.translate("MainWindow", u"Sign up", None))
        self.label_sign_up_result.setText("")
    # retranslateUi
